...
const compliments = [
    ...
    "Обнимаю <3",
    "С тобой мне хорошо <3",
    "Ты моя люпимая",
    "Красивая самая",
    "Мой котеночек <3",
    "Моя собачка милая",
    "Люблю еще раз очень очень"
];
...
const mediaData = [
    {
        ...
        comment: 'Помнишь наши первые сообщение друг другу?)',
        muted: false
    },
    {
        type: 'video',
        src: 'images/video3.mp4',
        comment: 'Я люблю тебя очень сильно ❤️',
        muted: false
    },
    {
        type: 'video',
        src: 'images/video2.mp4',
        comment: 'Я бы обнимал тебя вечность, моя любимая девочка ❤️ ',
        muted: false
    },
    {
        type: 'video',
        src: 'images/video4.mp4',
        comment: 'Хочу, чтобы у нас всегда все было хорошо, Люблю ❤️ ',
        muted: false
    },
